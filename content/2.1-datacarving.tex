\todo[inline]{fazer uma definição mais completa do trabalho}

\todo[inline]{pesquisar remontagem na literatura}

\todo[inline]{Baseline: usar resultados reportados, não precisa reproduzir tudo}
