...
% \todo[inline]{padronizar uso de proceedings nas referencias}

% \todo[inline]{padronizar por tipo de evento}

% \todo[inline]{verificar como mandar a versão final para a secretaria e para a banca}
