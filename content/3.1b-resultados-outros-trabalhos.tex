...
Most of the early work in this field used some form of dimensionality reduction in the input data before performing classification, as byte frequency distribution\todo{ref}, compression rate\todo{ref}, and various statistical techniques\todo{ref}. The usage of raw bytes as input is recently becoming more popular, especially in studies applying machine learning techniques, which seems to be a rising trend in the last ten years.

\todo[inline]{introduction to list of studies, what is their goal? accuracy of what?}
...
Using 18 file types, they got a macro average f1 score \todo{ref} of 61\% using CNN and 81\% using MLP.

\todo[inline]{check spellings of f1 score, F1 score, F1-score}
