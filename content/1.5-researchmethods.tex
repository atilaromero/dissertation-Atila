...
\todo[inline]{shuffling data to simulate fragmentation}
\todo[inline]{removal of portions of files to simulate data corruption}
\todo[inline]{increase in the number of supported file types, investigating the best strategy to scale the solution}
