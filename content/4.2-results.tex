...
%\levelB{Software}
The main software and frameworks used to build the experiments were {\color{red}Python 3.6 \cite{rossum_python_2019}, Jupyter notebook \cite{perez_jupyter_2019}, Tensorflow 1.14.0 \cite{google_brain_tensorflow_2019}, Keras 2.2.4-tf \cite{chollet_keras_2019}}, and Fedora Linux 27.
