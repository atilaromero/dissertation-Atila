...
The data feeded to the PCA algorithm is shown on Table \ref{tab:pcadata}.
% \todo[inline]{Tabela para pares de classes,  deixar mais claro quais são os pares}
\input{content/tables/pca-table.tex}
