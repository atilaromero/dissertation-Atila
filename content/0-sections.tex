...
%4
\levelA{\label{chap:models}Comparison of models}
...
%5
\levelA{\label{chap:nclasses}Influence of number of classes}
...
%6
\levelA{\label{chap:random}High entropy data}
    \input{content/6-random.tex}

    \levelB{Method}
    \input{content/6.1-method.tex}
