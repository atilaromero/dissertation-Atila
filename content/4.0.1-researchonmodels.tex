...
% Constraints
The models where trained until no further improvement was observed in the last 60 epochs. \todo{60 is much higher than 10, which was used in sections 4.2 and 4.3, leading to difference in accuracy results}
